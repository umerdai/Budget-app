<template>
  <div class="flex flex-col p-6">
    <h1 class="text-2xl font-bold mb-4 text-center">Outgoing Transactions</h1>

    <!-- Outgoing Transactions Table -->
    <div class="mb-6 ">
      <div class="overflow-y-auto max-h-80">
      <h2 class="text-xl font-semibold mb-2">Outgoing Transactions</h2>
...
const fetchTransactions = async () => {
  try {
    ...
    if (userId) {
      ...
      incomingTransactions.value = data.filter(transaction => transaction.type === 'outgoing');
